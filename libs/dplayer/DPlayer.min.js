  ...
  return (function (e) {
    ...
    function (e, t, n) {
      ...
      ;(function (t) {
        ...
        var s,
          l = {
            adapter:
              ('undefined' != typeof XMLHttpRequest ? (s = n(10)) : void 0 !== t && (s = n(10)), s),
            transformRequest: [
              function (e, t) {
                return (
                  a(t, 'Content-Type'),
              ...
              value: function () {
                ;((this.template.infoVersion.innerHTML = 'v1.25.0 fdcf45b'),
                  ...
                  (this.template.infoResolution.innerHTML =
                    this.player.video.videoWidth + ' x ' + this.player.video.videoHeight),
          ...
          i(e, [
            {
              ...
              value: function (e, t) {
                ...
                ;(e + this.player.template.menu.offsetWidth >= n.width
                  ? ((this.player.template.menu.style.right = n.width - e + 'px'),
                  ...
                  t + this.player.template.menu.offsetHeight >= n.height
                    ? ((this.player.template.menu.style.bottom = n.height - t + 'px'),
          ...
          ;(!(function (e, t) {
            ...
            this.player.template.commentColorSettingBox.addEventListener('click', function () {
              if (n.player.template.commentColorSettingBox.querySelector('input:checked+span')) {
                var e =
                  n.player.template.commentColorSettingBox.querySelector('input:checked').value
            ...
            },
            {
              ...
              value: function (e) {
                ;((this.container.style.backgroundPosition =
                  '-' + 160 * (Math.ceil((e / this.barWidth) * 100) - 1) + 'px 0'),
                    ...
                    for (var n = 0; n < e.player.options.highlight.length; n++)
                      if (
                        ...
                        ;(i.classList.add('dplayer-highlight'),
                          (i.style.left =
                            (e.player.options.highlight[n].time / e.player.video.duration) * 100 +
                            '%'),
                          (i.innerHTML =
              ...
              value: function () {
                var e = this,
                  t = function (t) {
                    var n =
                      ((t.clientX || t.changedTouches[0].clientX) -
                        a.default.getBoundingClientRectViewLeft(e.player.template.playedBarWrap)) /
                    ...
                    var n = t || window.event,
                      i =
                        ((n.clientX || n.changedTouches[0].clientX) -
                          a.default.getBoundingClientRectViewLeft(e.player.template.volumeBarWrap) -
                          5.5) /
                        35
                    e.player.volume(i)
                  },
                ...
                this.loadingChecker = setInterval(function () {
                  e.enableloadingChecker &&
                    ...
                    i ||
                      ...
                      (e.player.container.classList.add('dplayer-loading'), (i = !0)),
                    i &&
                      n > t &&
                      !e.player.video.paused &&
                      (e.player.container.classList.remove('dplayer-loading'), (i = !1)),
                    (t = n))
                }, 100)
              },
            },
          ...
          a(e, [
            {
              ...
              value: function () {
                switch (
                  arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 'browser'
                ) {
                  case 'browser':
                    return (
                      document.fullscreenElement ||
          ...
          o(e, [
            ...
            },
            {
              ...
              value: function (e) {
                if (void 0 !== e) {
                  for (
                    var t = this.container.getElementsByClassName('dplayer-danmaku-item'), n = 0;
                    n < t.length;
                    n++
                  )
                    t[n].style.opacity = e
                    ...
                    var d = document.createDocumentFragment(),
                      p = function (a) {
                        ...
                        ;(o.classList.add('dplayer-danmaku-item'),
                          ...
                          e[a].border
                            ? (o.innerHTML =
                                '<span style="border:' + e[a].border + '">' + e[a].text + '</span>')
    ...
    function (e, t, n) {
      ...
      e.exports = function (e) {
        ...
        return (
          ...
          r.danmaku &&
            r.danmaku.bottm &&
            ((a += ' style="margin-bottom:'), (a += s(r.danmaku.bottm)), (a += '"')),
          (a +=
          ...
          i(e, [
            {
              ...
              value: function () {
                ;((this.container.innerHTML = (0, o.default)({
                  ...
                  (this.danmakuOpacityBarWrap =
                    this.container.querySelector('.dplayer-danmaku-bar')),
        ...
        return e
          ? (i.forEach(e.split('\n'), function (e) {
              if (
                ...
                r[t] =
                  'set-cookie' === t ? (r[t] ? r[t] : []).concat([n]) : r[t] ? r[t] + ', ' + n : n
              }
            }),
            r)
          : r
    ...
    function (e, t, n) {
      ...
      ;((s.prototype.request = function (e) {
        ;('string' == typeof e && (e = a.merge({ url: arguments[0] }, arguments[1])),
          ((e = a.merge(i, { method: 'get' }, this.defaults, e)).method = e.method.toLowerCase()))
        var t = [r, void 0],
          n = Promise.resolve(e)
        for (
      ...
      t.default = function (e) {
        ...
        return (
          ...
          (e.contextmenu = e.contextmenu.concat([
            ...
            { text: 'DPlayer v1.25.0', link: 'https://github.com/MoePlayer/DPlayer' },
          ])),
          e
        )
      }
      ...
      ;(function (e) {
        ...
        ;((c.prototype.catch = function (e) {
            ...
            return new c(function (t, n) {
              ...
              function r(e, s) {
                try {
                  if (
                    s &&
                    ('object' === (void 0 === s ? 'undefined' : a(s)) || 'function' == typeof s)
                  ) {
                    var l = s.then
          ...
          (c.resolve = function (e) {
            return e && 'object' === (void 0 === e ? 'undefined' : a(e)) && e.constructor === c
              ? e
              : new c(function (t) {
                  t(e)
                })
            ...
            i(
              ...
              [
                ...
                },
                {
                  ...
                  value: function () {
                    this.volume() >= 0.95
                      ? (this.template.volumeIcon.innerHTML = c.default.volumeUp)
                      : this.volume() > 0
                        ? (this.template.volumeIcon.innerHTML = c.default.volumeDown)
                        : (this.template.volumeIcon.innerHTML = c.default.volumeOff)
                  },
                },
                {
                  key: 'volume',
                  ...
                  value: function (e, t) {
                    ...
                    if (
                      ...
                      switch (
                        ...
                        case 'dash':
                          dashjs
                            ? dashjs.MediaPlayer().create().initialize(e, e.src, !1)
                  ...
                  value: function (e, t) {
                    ...
                    ;(this.initMSE(e, t),
                      this.on('durationchange', function () {
                        1 !== e.duration &&
                          e.duration !== 1 / 0 &&
                          (n.template.dtime.innerHTML = o.default.secondToTime(e.duration))
                      }),

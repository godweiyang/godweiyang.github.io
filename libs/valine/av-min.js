  ...
  return (function (t) {
      ...
      ;(function () {
        ...
        ;((O.each = O.forEach =
          ...
          (O.map = O.collect =
            function (t, e, n) {
              e = A(e, n)
              for (
                var r = !x(t) && O.keys(t), i = (r || t).length, s = Array(i), o = 0;
                o < i;
                o++
              ) {
                var a = r ? r[o] : o
          ...
          (O.find = O.detect =
            function (t, e, n) {
              var r
              if (void 0 !== (r = x(t) ? O.findIndex(t, e, n) : O.findKey(t, e, n)) && -1 !== r)
                return t[r]
            }),
          (O.filter = O.select =
            function (t, e, n) {
        ...
        ;((O.groupBy = U(function (t, e, n) {
          ...
          (O.last = function (t, e, n) {
            if (null != t)
              return null == e || n ? t[t.length - 1] : O.rest(t, Math.max(0, t.length - e))
          }),
          (O.rest =
            O.tail =
            O.drop =
          ...
          (O.debounce = function (t, e, n) {
            var r,
              ...
              u = function () {
                ...
                c < e && c >= 0
                  ? (r = setTimeout(u, e - c))
                  : ((r = null), n || ((a = t.apply(s, i)), r || (s = i = null)))
              }
            return function () {
        ...
        var D = function (t, e, n, r) {
          ...
          if (!s) {
            ...
            if (
              o !== a &&
              !(O.isFunction(o) && o instanceof o && O.isFunction(a) && a instanceof a) &&
              'constructor' in t &&
              'constructor' in e
            )
              return !1
        ...
        ;((O.template = function (t, e, n) {
          ...
          var r = RegExp(
              [(e.escape || J).source, (e.interpolate || J).source, (e.evaluate || J).source].join(
                '|',
              ) + '|$',
              'g',
            ),
        ...
        ;((O.mixin = function (t) {
          ...
          O.mixin(O),
          O.each(['pop', 'push', 'reverse', 'shift', 'sort', 'splice', 'unshift'], function (t) {
            var e = l[t]
      ...
      var r = n(50),
        ...
        p = function () {
          ...
          return (
            'boolean' == typeof t.useMasterKey
              ? (r = t.useMasterKey)
              : 'boolean' == typeof u._config.useMasterKey && (r = u._config.useMasterKey),
            r
              ? u.masterKey
                ? e
                  ? (n['X-LC-Sign'] = f(u.masterKey, !0))
                  : (n['X-LC-Key'] = u.masterKey + ',master')
                : (console.warn('masterKey is not set, fall back to use appKey'), d(n, e))
              : d(n, e),
        ...
        y = function (t, e, n, r) {
          var i = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : {},
            ...
            u = ''
          if (
            (t && (u += '/' + t), e && (u += '/' + e), n && (u += '/' + n), i && i._fetchWhenSave)
          )
        ...
        l = function (t) {
          ...
          return new u(function (t, r) {
            ...
            ;(f && i.on('progress', f),
              i.end(function (e, n) {
                return (
                  n && a('response(' + d + ')', n.status, n.body || n.text, n.header),
                  e
                    ? (n &&
    ...
    function (t, e, n) {
      ...
      ;(function (e) {
        var r = n(0),
          ...
          a = s.parseDate,
          u = e.AV || {}
        ;((u._config = { serverURLs: {}, useMasterKey: !1, production: null, realtime: null }),
        ...
        ;((u._installationId = null),
          ...
          (u._decode = function (t, e) {
            ...
            if ('GeoPoint' === t.__type)
              return new u.GeoPoint({ latitude: t.latitude, longitude: t.longitude })
    ...
    function (t, e, n) {
        ...
        for (var e, n, r = {}, i = t.split('&'), s = 0, o = i.length; s < o; ++s)
          ((e = i[s]),
            ...
            -1 == n
              ...
              : (r[decodeURIComponent(e.slice(0, n))] = decodeURIComponent(e.slice(n + 1))))
        return r
      }
      function a(t) {
        var e,
      ...
      ;((g.serializeObject = i),
        ...
        (g.parse = { 'application/x-www-form-urlencoded': o, 'application/json': JSON.parse }),
        m(c.prototype),
        ...
        (l.prototype._end = function () {
          ...
          ;(this._setTimeouts(),
            (e.onreadystatechange = function () {
              var n = e.readyState
              if (
                (n >= 2 && t._responseTimeoutTimer && clearTimeout(t._responseTimeoutTimer), 4 == n)
              ) {
                var r
                try {
                  r = e.status
        ...
        ;((t.Cloud = t.Cloud || {}),
          r.extend(t.Cloud, {
            ...
            rpc: function (e, n, i) {
              return r.isArray(n)
                ? a.reject(
                    new Error("Can't pass Array as the param of rpc function in JavaScript SDK."),
                  )
                : o({
                    service: 'engine',
                    method: 'POST',
            ...
            requestSmsCode: function (t) {
              ...
              if ((r.isString(t) && (t = { mobilePhoneNumber: t }), !t.mobilePhoneNumber))
        ...
        ;((t.Events = {
          ...
          trigger: function (t) {
            ...
            for (u = s.all, t = t.split(e), c = n.call(arguments, 1), r = t.shift(); r; ) {
              if ((i = s[r]))
                for (o = i.tail; (i = i.next) !== o; ) i.callback.apply(i.context || this, c)
              if ((i = u))
    ...
    function (t, e, n) {
      ...
      t.exports = function (t) {
        ...
        ;((t.File = function (e, i, s) {
          if (((this.attributes = { name: e, url: '', metaData: {}, base64: '' }), r.isString(i)))
            throw new TypeError('Creating an AV.File from a String is not yet supported.')
          ;(r.isArray(i) && ((this.attributes.metaData.size = i.length), (i = { base64: _(i) })),
            (this._extName = ''),
            (this._data = i),
          ...
          r.extend(t.File.prototype, {
            ...
            thumbnailURL: function (t, e, n, r, i) {
              ...
              return (
                (i = i || 'png'),
                s + '?imageView/' + (r ? 2 : 1) + '/w/' + t + '/h/' + e + '/q/' + n + '/format/' + i
              )
            },
            size: function () {
            ...
            save: function (t) {
              ...
              if (!this._previousSave)
                if (this._data) {
                  ...
                  this._previousSave = u('files', this.attributes.name, null, 'post', r).then(
                    function (t) {
                      return (
            ...
            _callback: function (t) {
              ;(u('fileCallback', null, null, 'post', { token: this._token, result: t }).catch(d),
                delete this._token,
                delete this._data)
            },
            fetch: function (t, e) {
    ...
    function (t, e, n) {
      ...
      t.exports = function (t) {
        ;((t.GeoPoint = function (e, n) {
          r.isArray(e)
            ? (t.GeoPoint._validate(e[0], e[1]), (this.latitude = e[0]), (this.longitude = e[1]))
            : r.isObject(e)
              ? (t.GeoPoint._validate(e.latitude, e.longitude),
                (this.latitude = e.latitude),
                (this.longitude = e.longitude))
              : r.isNumber(e) && r.isNumber(n)
                ? (t.GeoPoint._validate(e, n), (this.latitude = e), (this.longitude = n))
          ...
          r.extend(t.GeoPoint.prototype, {
            toJSON: function () {
              return (
                ...
                { __type: 'GeoPoint', latitude: this.latitude, longitude: this.longitude }
              )
            },
        ...
        ;(i._setServerURLs(c({}, r(e, u), i._config.serverURLs, h), v),
          _
            ...
            : i._sharedConfig.liveQueryRealtime &&
              (i._config.realtime = new i._sharedConfig.liveQueryRealtime({ appId: e, region: u })))
      }),
          ...
          r,
          {
            ...
            _dispatch: function (e) {
              ...
              e.forEach(function (e) {
                ...
                if (s === n.id) {
                  var a = t.parseJSON(
                    Object.assign({ __type: '_File' === i.className ? 'File' : 'Object' }, i),
                  )
            ...
            init: function (e) {
              ...
              return i.resolve(s).then(function (n) {
                return u({
                  ...
                  data: {
                    query: { where: a, keys: c, returnACL: l, className: e.className },
                    id: n,
                  },
                }).then(function (e) {
                  var r = e.query_id
          ...
          i.extend(t.Object.prototype, t.Events, {
              ...
              return (
                t._arrayEach(r, function (r) {
                  e[r] &&
                    ('objectId' === r
                      ? (n.id = e[r])
                      : ('createdAt' !== r && 'updatedAt' !== r) || i.isDate(e[r])
                        ? (n[r] = e[r])
            ...
            set: function (e, n, r) {
              ...
              ;(t._objectEach(o, function (e, n) {
                e instanceof t.Op &&
                  ((o[n] = e._estimate(a.attributes[n], a, n)), o[n] === t.Op._UNSET && delete o[n])
              }),
                this._validate(s, r),
                (r.changes = {}))
              ...
              return (
                t._arrayEach(i.keys(s), function (e) {
                  ...
                  var o = !0
                  ;(n instanceof t.Op.Set && i.isEqual(a.attributes[e], n.value) && (o = !1),
                    o && (delete u[e], r.silent ? (a._silent[e] = !0) : (r.changes[e] = !0)))
                  var c = i.last(a._opSetQueue)
                  ;((c[e] = n._mergeWithPrevious(c[e])),
                    a._rebuildEstimatedDataForKey(e),
                    o
                      ? ((a.changed[e] = a.attributes[e]), r.silent || (a._pending[e] = !0))
            ...
            save: function (e, n, r) {
              var s, o, u
              ;(i.isObject(e) || c(e) ? ((s = e), (u = n)) : ((s = {}), (s[e] = n), (u = r)),
                (u = i.clone(u) || {}),
              ...
              return (
                ...
                f.length + d.length > 0
                  ? t.Object._deepSaveAsync(this.attributes, h, u).then(function () {
                      return h.save(null, u)
                    })
                  : (this._startSave(),
                    (this._saving = (this._saving || 0) + 1),
                    (this._allPreviousSaves = this._allPreviousSaves || t.Promise.resolve()),
            ...
            destroy: function (t) {
              ...
              return this.id
                ? (t.wait || n(),
                  a('classes', this.className, this.id, 'DELETE', this._flags, t).then(function () {
                    return (t.wait && n(), e)
                  }))
                : n()
            },
                  ...
                  function () {
                    ...
                    if (
                      ...
                      return t.Promise.reject(
                        new s(s.OTHER_CAUSE, 'Tried to save a batch with a cycle.'),
                      )
            ...
            toJSON: function () {
              ...
              return (
                this.relationsToAdd.length > 0 &&
                  ((s = r.map(this.relationsToAdd, i)), (t = { __op: 'AddRelation', objects: s })),
          ...
          r.extend(t.Query.prototype, {
            ...
            get: function (t, e) {
              ...
              return (
                ...
                u('classes', this.className, t, 'GET', h(s), e).then(function (t) {
            ...
            toJSON: function () {
              ...
              return (
                this._include.length > 0 && (e.include = this._include.join(',')),
            ...
            _createRequest: function () {
              var t =
                  arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.toJSON(),
                e = arguments[1]
              if (JSON.stringify(t).length > 2e3) {
                var n = {
                  requests: [{ method: 'GET', path: '/1.1/classes/' + this.className, params: t }],
                }
            ...
            query: function () {
              ...
              return (
                this.targetClassName
                  ? ((e = t.Object._getSubclass(this.targetClassName)), (n = new t.Query(e)))
      ...
      t.exports = function (t) {
        t.Role = t.Object.extend('_Role', {
          constructor: function (e, n) {
            if (
              (r.isString(e)
                ? (t.Object.prototype.constructor.call(this, null, null), this.setName(e))
        ...
        ;((t.SearchSortBuilder = function () {
          ...
          r.extend(t.SearchSortBuilder.prototype, {
            _addField: function (t, e, n, r) {
              var i = {}
              return (
                (i[t] = { order: e || 'asc', mode: n || 'avg', missing: '_' + (r || 'last') }),
      ...
      t.exports = function (t) {
        ...
        ;((t.Status = function (t, e) {
          ...
          (t.Status.countUnreadStatuses = function (n) {
            ...
            if ((i.isString(r) || (o = r), !a(o) && null == n && !t.User.current()))
        ...
        t.User = t.Object.extend(
          '_User',
          {
            ...
            _handleSaveResult: function (e) {
              return (
                e && !t._config.disableCurrentUser && (this._isCurrentUser = !0),
            ...
            _linkWith: function (e, n) {
              var i,
                s = this
              if (
                (r.isString(e) ? ((i = e), (e = t.User._authProviders[e])) : (i = e.getAuthType()),
                n)
              ) {
            ...
            signUp: function (t, e) {
              ...
              if (!n || '' === n)
                throw new i(i.OTHER_CAUSE, 'Cannot sign up user with an empty name.')
              var r = (t && t.password) || this.get('password')
              if (!r || '' === r)
                throw new i(i.OTHER_CAUSE, 'Cannot sign up user with an empty password.')
              ...
              return (
                ...
                n.then(function () {
                  ...
                  return (
                    ...
                    t.localStorage
                      .setItemAsync(t._getAVPath(t.User._CURRENT_USER_KEY), JSON.stringify(n))
                      .then(function () {
              ...
              .then(function (e) {
                if (!t.disabled) {
                  ...
                  return (
                    ...
                    t.lock(n),
                    o.setAsync('serverURLs', { serverURLs: r, lockedUntil: t.lockedUntil }, n)
                  )
                }
              })
              .catch(function (e) {
          ...
          ;(o.onprogress && u.on('progress', o.onprogress),
            u.end(function (e, r) {
              if ((r && i(r.status, r.body, r.text), e))
                return (
                  r &&
                    ((e.statusCode = r.status), (e.responseText = r.text), (e.response = r.body)),
                  s(e)
                )
              t(n)
            }))
    ...
    function (t, e, n) {
      ...
      var r = n(7),
        ...
        s = function (t, e) {
          return (
            e && ((t.statusCode = e.status), (t.responseText = e.text), (t.response = e.body)),
            t
          )
        }
      t.exports = function (t, e, n) {
      ...
      var r = function (t, e) {
        ...
        t.indexOf('base64') < 0
          ...
          : t.split(',')[0].indexOf('base64') >= 0
            ? ((e = e || t.split(',')[0].split(':')[1].split(';')[0]), (n = atob(t.split(',')[1])))
    ...
    function (t, e, n) {
      ;(function (e) {
        ...
        !(function (e, n) {
          ...
          function y(t, e, n) {
            e.constructor === t.constructor && n === c && e.constructor.resolve === l
              ? m(t, e)
              : n === rt
          ...
          function w(t, e) {
            t._state === tt &&
              ((t._result = e), (t._state = et), 0 !== t._subscribers.length && W(A, t))
          }
          function O(t, e) {
          ...
          function N(t, e, n, i) {
            ...
            if (s) {
              if (
                ((o = T(n, i)),
                o === it ? ((c = !0), (a = o.error), (o.error = null)) : (u = !0),
                e === o)
              )
                return void O(e, d())
            } else ((o = i), (u = !0))
            e._state !== tt ||
              (s && u ? g(e, o) : c ? O(e, a) : t === et ? w(e, o) : t === nt && O(e, o))
          }
          function C(t, e) {
            try {
              e(
          ...
          function q(t) {
            ;((this[Z] = j()),
              ...
              (this._subscribers = []),
              h !== t && ('function' != typeof t && D(), this instanceof q ? C(this, t) : L()))
          }
          function M() {
            var t = void 0
            if (void 0 !== e) t = e
          ...
          return (
            ...
            (U.prototype._settledAt = function (t, e, n) {
              var r = this.promise
              ;(r._state === tt && (this._remaining--, t === nt ? O(r, n) : (this._result[e] = n)),
    ...
    function (t, e, n) {
      ...
      ;(Object.create && ((r.prototype = Object.create(null)), new r().__proto__ || (a = !1)),
        ...
        (s.prototype.removeListener = function (t, e, n, i) {
          ...
          if (!e)
            return (
              0 == --this._eventsCount ? (this._events = new r()) : delete this._events[s],
              this
            )
        ...
        (s.prototype.removeAllListeners = function (t) {
          ...
          return (
            t
              ? ((e = a ? a + t : t),
                this._events[e] &&
                  (0 == --this._eventsCount ? (this._events = new r()) : delete this._events[e]))
              : ((this._events = new r()), (this._eventsCount = 0)),
            this
          )
        }),
        ...
        var e = n(44),
          ...
          o = function (t, n) {
            t.constructor == String
              ? (t = n && 'binary' === n.encoding ? s.stringToBytes(t) : r.stringToBytes(t))
              : i(t)
    ...
    function (t, e) {
      ...
      function i(t) {
        return (
          s(t, c, 'day') || s(t, u, 'hour') || s(t, a, 'minute') || s(t, o, 'second') || t + ' ms'
        )
      }
      function s(t, e, n) {
        if (!(t < e))

    ...
    function (e, t, n) {
        ...
        (r.prototype._init = function () {
          ...
          try {
            ...
            ;((AV.applicationId && delete AV._config.applicationId) || (AV.applicationId = void 0),
              (AV.applicationKey && delete AV._config.applicationKey) ||
                (AV.applicationKey = void 0))
            var z =
              '-MdYXbMMI' === C.slice(-9) ? 'https://us.avoscloud.com' : 'https://avoscloud.com'
            ...
            e.loading = {
              show: function (t) {
                ...
                return (t ? U.insertBefore(P, n[0]) : U.appendChild(P), e.nodata.hide(), e)
              },
              hide: function () {
                var t = u.find(U, '.vloading')
                return (t && u.remove(t), 0 === u.findAll(U, '.vcard').length && e.nodata.show(), e)
              },
            }
            ...
            ;((e.alert = {
              show: function (t) {
                ...
                if (
                  ...
                  u.on('click', u.find(N, '.vcancel'), function (t) {
                    e.alert.hide()
                  }),
                    ...
                    e.length > 0 &&
                      u.each(e, function (e, t) {
                        var n = t.get('url'),
                          r = t.get('time'),
                          i =
                            u.findAll(document, '.leancloud_visitors[id="' + n + '"]') ||
                            u.findAll(document, '.leancloud-visitors[id="' + n + '"]')
      ...
      ;((r.prototype.Q = function (e) {
        ...
        (r.prototype.ErrorHandler = function (e) {
          ...
          if ((t.el && t.loading.hide().nodata.hide(), '[object Error]' === {}.toString.call(e))) {
            ...
            101 == n
              ? t.nodata.show()
              : (t.el &&
                  t.nodata.show('<pre style="text-align:left;">Code ' + n + ': ' + i + '</pre>')) ||
                console
          } else
            (t.el &&
              t.nodata.show('<pre style="text-align:left;">' + JSON.stringify(e) + '</pre>')) ||
              console
        }),
        ...
        (r.prototype.bind = function (e) {
                ...
                u.each(n, function (e, t) {
                  1 === t.nodeType &&
                    (r.indexOf(t.nodeName) > -1 &&
                      ('INPUT' === t.nodeName && 'checkbox' === u.attr(t, 'type')
          ...
          for (
            var k = t.config.meta, A = {}, _ = { veditor: 'comment' }, O = 0, S = k.length;
            O < S;
            O++
          )
            _['v' + k[O]] = k[O]
                ...
                ;((A[e] = n),
                  n &&
                    u.on('input change blur', n, function (t) {
                      'comment' === e
                        ? w(n)
                        : (v[e] = u.escape(n.value.replace(/(^\s*)|(\s*$)/g, '')))
                    }))
              })()
          var E = function (e, t) {
              ...
              e > 0
                ? (u.attr(u.find(t.el, '.vinfo'), 'style', 'display:block;'),
                  (u.find(t.el, '.vcount').innerHTML =
                    '<span class="vnum">' + e + '</span> ' + t.locale.tips.comments),
                  C())
                : t.loading.hide()
            })
            .catch(function (e) {
          ...
          var L = function (e, n, r) {
              ...
              ;((p = f
                ...
                (i.innerHTML =
                  ...
                  '\n                </div>\n            </div>'))
              for (
                var h = u.find(i, '.vat'), v = u.findAll(i, 'a'), g = 0, x = v.length;
                g < x;
                g++
              ) {
                var y = v[g]
                y &&
                  ...
                  u.attr(y, { target: '_blank', rel: 'nofollow' })
              }
          ...
          var B = function () {
            ...
            P = function (e) {
              return u.attr(I, 'disabled')
                ...
                : '' == v.comment
                  ? void A.comment.focus()
                  : ((v.nick = v.nick || 'Anonymous'), void (t.notify || t.verify ? V(N) : N()))
            },
            U = function () {
              var e = new AV.ACL()
                ...
                n
                  ...
                  .then(function (e) {
                    'Anonymous' != v.nick &&
                      ...
                      x.setItem(
                        'ValineCache',
                        JSON.stringify({ nick: v.nick, link: v.link, mail: v.mail }),
                      )
                    ...
                    try {
                      if (R.rid) {
                        ...
                        (n
                          ...
                          : (u.find(t.el, '.vcount').innerHTML =
                              '<span class="num">1</span> ' + t.locale.tips.comments),
                          L(e, u.find(t.el, '.vlist')))
                      ;(v.mail && Q({ username: v.nick, mail: v.mail }),
                        R.at &&
                          R.rmail &&
                          t.notify &&
                          F({ username: R.at.replace('@', ''), mail: R.rmail }),
      ...
      !(function (i) {
        ...
        function g(e, t) {
          var n,
            ...
            a = []
          for (
            o[15] = a[15] = void 0, i.length > 16 && (i = p(i, 8 * e.length)), n = 0;
            n < 16;
            n += 1
          )
        ...
        !(function (t) {
          ...
          function r(e, t) {
            ...
            this.options.pedantic
              ...
              : this.options.gfm &&
                (this.options.breaks ? (this.rules = g.breaks) : (this.rules = g.gfm))
          }
          function i(e) {
            this.options = e || h.defaults
          }
                ...
                if (
                  ...
                  for (
                    e = e.substring(i[0].length),
                      o = i[2],
                      p = o.length > 1,
                      this.tokens.push({ type: 'list_start', ordered: p, start: p ? +o : '' }),
          ...
          ;((g._escapes = /\\([!"#$%&'()*+,\-.\/:;<=>?@\[\]\\^_`{|}~])/g),
            ...
            (a.prototype.parse = function (e) {
              ;((this.inline = new r(e.links, this.options)),
                (this.inlineText = new r(e.links, p({}, this.options, { renderer: new o() }))),
            ...
            (a.prototype.tok = function () {
              switch (this.token.type) {
                ...
                case 'list_item_start':
                  for (
                    o = '', this.token.task && (o += this.renderer.checkbox(this.token.checked));

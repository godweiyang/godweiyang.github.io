var Gitment = (function (a) {
    ...
    !function (c) {
      function i(a) {
        return function (b, c, d) {
          return d && 'function' == typeof d.value
            ? ((d.value = _(a, d.value)), (d.enumerable = !1), (d.configurable = !0), d)
      ...
      function o(a, b, c, d) {
        ...
        return (
          'string' == typeof a
            ? ((e = a), (f = b), (g = c), (h = d))
            : ((e = a.name || 'AutorunAsync@' + td()), (f = a), (g = b), (h = c)),
          vd(k(f) === !1, qd('m006')),
          void 0 === g && (g = 1),
          h && (f = f.bind(h)),
          (i = !1),
      ...
      function p(a, b, c) {
        ...
        return (
          ...
          rc(a) && ud(qd('m008')),
          (e = 'object' === ('undefined' == typeof c ? 'undefined' : d(c)) ? c : {}),
      ...
      function v(a) {
        if (null === a || 'object' !== ('undefined' == typeof a ? 'undefined' : d(a)))
          throw new Error('[mobx] transform expected some kind of object, got: ' + a)
        var b = a.$transformId
      ...
      function z(a, b, c) {
        ...
        for (
          vd(arguments.length >= 2, qd('m014')),
            vd('object' === ('undefined' == typeof a ? 'undefined' : d(a)), qd('m015')),
            vd(!Oc(a), qd('m016')),
            c.forEach(function (a) {
              ;(vd('object' === ('undefined' == typeof a ? 'undefined' : d(a)), qd('m017')),
                vd(!I(a), qd('m018')))
            }),
            e = Qc(a),
            f = {},
      ...
      function B(a) {
        var b = { name: a.name }
        return (
          a.observing && a.observing.length > 0 && (b.dependencies = Ad(a.observing).map(B)),
          b
        )
      }
      function C(a, b) {
      ...
      function W(a, b, c) {
        ...
        if ((void 0 === b && (b = !0), void 0 === c && (c = []), I(a))) {
          if (
            (b && null === c && (c = []),
            b && null !== a && 'object' === ('undefined' == typeof a ? 'undefined' : d(a)))
          )
            for (f = 0, g = c.length; g > f; f++) if (c[f][0] === a) return c[f][1]
          if (Kc(a)) {
            for (
              h = e([]),
                i = a.map(function (a) {
      ...
      function bb(a, b, c, d) {
        ...
        return (
          ...
          Nb(),
          (k = gb(!0)),
          { prevDerivation: j, prevAllowStateChanges: k, notifySpy: e, startTime: f }
        )
      }
      function cb(a) {
      ...
      function sb(a) {
        ...
        ;(Cb.computationDepth > 0 && b && ud(qd('m031') + a.name),
          !Cb.allowStateChanges && b && ud(qd(Cb.strictMode ? 'm030a' : 'm030b') + a.name))
      }
      function tb(a, b, c) {
        var d, e
        ;(zb(a),
      ...
      function ub(a) {
        ...
        for (a.newObserving = null, d = 0, e = a.unboundDepsCount, f = 0; e > f; f++)
          ((g = c[f]), 0 === g.diffValue && ((g.diffValue = 1), d !== f && (c[d] = g), d++))
      ...
      function zb(a) {
        ...
        if (a.dependenciesState !== nb.UP_TO_DATE)
          for (a.dependenciesState = nb.UP_TO_DATE, b = a.observing, c = b.length; c--; )
      ...
      function Lb(a, b) {
        ...
        1 === a.observers.length
          ...
          : ((c = a.observers),
            ...
            (e = c.pop()),
            e !== b &&
              ((f = d[b.__mapid] || 0), f ? (d[e.__mapid] = f) : delete d[e.__mapid], (c[f] = e)),
            delete d[b.__mapid])
      }
      function Mb(a) {
      ...
      function Pb(a) {
        ...
        null !== b
          ? b.runId !== a.lastAccessedBy &&
            ((a.lastAccessedBy = b.runId), (b.newObserving[b.unboundDepsCount++] = a))
          : 0 === a.observers.length && Mb(a)
      }
      function Rb(a) {
        var b, c, d
        if (a.lowestObserverState !== nb.STALE)
          for (a.lowestObserverState = nb.STALE, b = a.observers, c = b.length; c--; )
            ((d = b[c]),
          ...
          for (a.lowestObserverState = nb.STALE, b = a.observers, c = b.length; c--; )
            ((d = b[c]),
              d.dependenciesState === nb.POSSIBLY_STALE
                ? (d.dependenciesState = nb.STALE)
                : d.dependenciesState === nb.UP_TO_DATE && (a.lowestObserverState = nb.UP_TO_DATE))
      }
      function Tb(a) {
        var b, c, d
        if (a.lowestObserverState === nb.UP_TO_DATE)
          for (a.lowestObserverState = nb.POSSIBLY_STALE, b = a.observers, c = b.length; c--; )
            ((d = b[c]),
      ...
      function Vb(a) {
        ;(vd(this && this.$mobx && _b(this.$mobx), 'Invalid `this`'),
          vd(!this.$mobx.errorHandler, 'Only one onErrorHandler can be registered'),
            ...
            ++b === Xb &&
              (console.error(
                "Reaction doesn't converge to a stable state after " +
                  Xb +
                  ' iterations.' +
                  (' Probably there is a cycle in the reactive function: ' + a[0]),
              ),
              a.splice(0)),
              c = a.splice(0),
              d = 0,
        ...
        try {
          if ((d = a.interceptors))
            for (
              ...
              f > e &&
              ((b = d[e](b)),
              vd(!b || b.type, 'Intercept handlers should return nothing or a change object'),
              b);
              e++
            );
          return b
      ...
      function qc(a) {
        return (
          xd('asMap is deprecated, use observable.map or observable.shallowMap instead'),
          Q.map(a || {})
        )
      }
      function rc(a) {
        ...
        return function (b) {
          ...
          if (a < d.length) {
            if ((sb(c.atom), (e = d[a]), hc(c))) {
              if (((f = jc(c, { type: 'update', object: c.array, index: a, newValue: b })), !f))
                return
              b = f.newValue
            }
            ;((b = c.enhancer(b, e)),
            ...
            if (a !== d.length)
              throw new Error(
                '[mobx.array] Index out of bounds, ' + a + ' is larger than ' + d.length,
              )
      ...
      function Nc(a) {
        return (
          xd('`mobx.map` is deprecated, use `new ObservableMap` or `mobx.observable.map` instead'),
          Q.map(a)
        )
      }
      function Qc(a, b) {
        ...
        ;(vd(Object.isExtensible(a), qd('m035')),
          Dd(a) || (b = (a.constructor.name || 'ObservableObject') + '@' + td()),
      ...
      function Zc(a, b, c) {
        ...
        ;((c = e.prepareNewValue(c)),
          c !== bd &&
            ...
            (f =
              g || h
                ? { type: 'update', object: a, oldValue: e.value, name: b, newValue: c }
                : null),
            h && dc(f),
            e.setNewValue(c),
            g && mc(d, f),
            ...
            return (
              ...
              void 0 === b
                ...
                : ((e = c._data[b] || c._hasMap[b]),
                  vd(
                    !!e,
                    "the entry '" + b + "' does not exist in the observable map '" + gd(a) + "'",
                  ),
                  e)
            )
          if ((jd(a), ad(a)))
          ...
          void 0 !== b
            ...
            : kb(a) || mb(a) || _b(a)
              ...
              : Oc(a)
                ? a
                : (jd(a),
                  a.$mobx ? a.$mobx : (vd(!1, 'Cannot obtain administration from ' + a), void 0))
        )
      }
      function gd(a, b) {
        var c
            ...
            h
              ? (Hd(f, '__mobxLazyInitializers') ||
                  Jd(
                    ...
                    (f.__mobxLazyInitializers && f.__mobxLazyInitializers.slice()) || [],
                  ),
                (l = h.value),
                (m = h.initializer),
              ...
              : ((k = {
                  ...
                  get: function () {
                    return (
                      (this.__mobxInitializedProps && this.__mobxInitializedProps[g] === !0) ||
      ...
      function Od(a, b) {
        ...
        if (
          ...
          if (Rd(a) && Rd(b))
            return a.size !== b.size ? !1 : Od(Q.shallowMap(a).entries(), Q.shallowMap(b).entries())
      ...
      ;(Object.defineProperty(b, '__esModule', { value: !0 }),
          ...
          return (
            ...
            (a.prototype.get = function () {
              ;(vd(
                ...
                0 === Cb.inBatch
                  ? (Nb(), qb(this) && (this.value = this.computeValue(!1)), Ob())
            ...
            (a.prototype.trackAndCompute = function () {
              var a, b
              return (
                bc() && cc({ object: this.scope, type: 'compute', fn: this.derivation }),
                (a = this.value),
            ...
            (a.prototype.observe = function (a, b) {
              ...
              return m(function () {
                var g,
                  f = c.get()
                ;((!d || b) &&
                  ((g = xb()), a({ type: 'update', object: c, newValue: f, oldValue: e }), yb(g)),
                  (d = !1),
                  (e = f))
              })
            }),
        ...
        (Ub = (function () {
          ...
          return (
            ...
            (a.prototype.runReaction = function () {
              this.isDisposed ||
                ...
                qb(this) &&
                  ...
                  this.onInvalidate(),
                  this._isTrackPending && bc() && cc({ object: this, type: 'scheduled-reaction' })),
                Ob())
            }),
            (a.prototype.track = function (a) {
              ...
              ;(Nb(),
                (b = bc()),
                b && ((c = Date.now()), dc({ object: this, type: 'reaction', fn: a })),
                (this._isRunning = !0),
                (d = tb(this, a, void 0)),
                (this._isRunning = !1),
                (this._isTrackPending = !1),
            ...
            (a.prototype.reportExceptionInDerivation = function (a) {
              ...
              return this.errorHandler
                ...
                : ((c =
                  ...
                  (d = qd('m037')),
                  console.error(c || d, a),
                  bc() && cc({ type: 'error', message: c, error: a, object: this }),
          ...
          return (
            ...
            (a.prototype.spliceItemsIntoValues = function (a, b, c) {
              ...
              return c.length < yc
                ...
                : ((d = this.values.slice(a, a + b)),
                  (this.values = this.values.slice(0, a).concat(c, this.values.slice(a + b))),
                  d)
            }),
            (a.prototype.notifyArrayChildUpdate = function (a, b, c) {
              var d = !this.owned && bc(),
                ...
                f =
                  e || d
                    ? { object: this.array, type: 'update', index: a, newValue: b, oldValue: c }
                    : null
        ...
        (Dc = (function (a) {
          ...
          return (
            ...
            (b.prototype.move = function (a, b) {
              function c(a) {
                if (0 > a)
                  throw new Error('[mobx.array] Index out of bounds: ' + a + ' is negative')
                var b = this.$mobx.values.length
                if (a >= b)
                  throw new Error(
                    '[mobx.array] Index out of bounds: ' + a + ' is not smaller than ' + b,
                  )
              }
              var d, e
              ;(c.call(this, a),
                ...
                a !== b &&
                  ...
                  (e =
                    b > a
                      ? d.slice(0, a).concat(d.slice(a + 1, b + 1), [d[a]], d.slice(b + 1))
                      : d.slice(0, b).concat([d[a]], d.slice(b, a), d.slice(a + 1))),
                  this.replace(e)))
            }),
        ...
        [
          ...
          ;(vd('function' == typeof b, "Base function not defined on Array prototype: '" + a + "'"),
          ...
          return (
            ...
            (a.prototype.has = function (a) {
              return this.isValidKey(a)
                ? ((a = '' + a),
                  this._hasMap[a] ? this._hasMap[a].get() : this._updateHasMapEntry(a, !1).get())
                : !1
            }),
            ...
            (a.prototype.delete = function (a) {
              ...
              return (
                ...
                (a = '' + a),
                hc(this) && ((c = jc(this, { type: 'delete', object: this, name: a })), !c)
                  ? !1
                  : this._has(a)
                    ? ((d = bc()),
                      (e = kc(this)),
                      (c =
                        e || d
                          ? { type: 'delete', object: this, oldValue: this._data[a].value, name: a }
                          : null),
                      d && dc(c),
                      Y(function () {
            ...
            (a.prototype._updateHasMapEntry = function (a, b) {
              ...
              return (
                c
                  ? c.setNewValue(b)
                  : (c = this._hasMap[a] = new cd(b, vc, this.name + '.' + a + '?', !1)),
                c
              )
            }),
            (a.prototype._updateValue = function (a, b) {
              ...
              ;((b = c.prepareNewValue(b)),
                b !== bd &&
                  ...
                  (f =
                    e || d
                      ? { type: 'update', object: this, oldValue: c.value, name: a, newValue: b }
                      : null),
                  d && dc(f),
                  c.setNewValue(b),
                  e && mc(this, f),
            ...
            (a.prototype._addValue = function (a, b) {
              ...
              ;(Y(function () {
                ...
                (d = bc()),
                (e = kc(this)),
                (f = e || d ? { type: 'add', object: this, name: a, newValue: b } : null),
                d && dc(f),
                e && mc(this, f),
                d && fc())
            }),
          ...
          return (
            ...
            (b.prototype.set = function (a) {
              ...
              ;((a = this.prepareNewValue(a)),
                a !== bd &&
                  ((c = bc()),
                  c && dc({ type: 'update', object: this, newValue: a, oldValue: b }),
                  this.setNewValue(a),
                  c && fc()))
            }),
            ...
            (b.prototype.setNewValue = function (a) {
              ...
              ;((this.value = a),
                this.reportChanged(),
                kc(this) && mc(this, { type: 'update', object: this, newValue: a, oldValue: b }))
            }),
            ...
            (b.prototype.observe = function (a, b) {
              return (
                b && a({ object: this, type: 'update', newValue: this.value, oldValue: void 0 }),
                lc(this, a)
              )
            }),
            (b.prototype.toJSON = function () {
  ...
  function (a, b, c) {
    ...
    function h(a, b) {
      ...
      if (((k.lang = 'en-US'), (k.className = 'gitment-container gitment-comments-container'), j))
        return (
          ...
          ;((f.className = 'gitment-comment'),
            (f.innerHTML =
              ...
              (c.toString() !== d.toString()
                ? ' • <span title="comment was edited at ' + d + '">edited</span>'
                : '') +
    ...
    function i(a, b) {
      ...
      return (
        ...
        (g.innerHTML =
          ...
          '>Comment</button>\n    </div>\n  '),
        c.login &&
          (g.querySelector('.gitment-editor-logout-link').onclick = function () {
            return b.logout()
          }),
    ...
    function i(a) {
      return function (b) {
        ...
        return (
          ...
          'GET' !== a &&
            'DELETE' !== a &&
            ((j = JSON.stringify(c)), f.setRequestHeader('Content-Type', 'application/json')),
          f.send(j),
          k
        )
      }
        ...
        function a() {
          ...
          try {
            ;((h = localStorage.getItem(f.LS_USER_KEY)),
              this.accessToken && h && Object.assign(d, JSON.parse(h), { fromCache: !0 }))
          } catch (j) {
            ...
            },
            {
              ...
              value: function () {
                var a = this,
                  ...
                  d = this.repo
                return g.http
                  .get('/repos/' + c + '/' + d + '/issues', { creator: c, labels: b })
                  .then(function (b) {
                    return b.length
                    ...
                    Promise.all(
                      b.map(function (b) {
                        ...
                        var c = a.owner,
                          d = a.repo
                        return g.http.get(
                          '/repos/' + c + '/' + d + '/issues/comments/' + b.id + '/reactions',
                          {},
                        )
                      }),
                    ).then(function (d) {
              ...
              value: function (a) {
                ...
                return this.accessToken
                  ? ((c = this.owner),
                    ...
                    g.http
                      .post('/repos/' + c + '/' + d + '/issues/comments/' + a + '/reactions', {
                        content: 'heart',
                      })
                      .then(function (c) {

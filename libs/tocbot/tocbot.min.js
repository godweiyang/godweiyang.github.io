!(function (e) {
    ...
    e.exports = function (e) {
      ...
      function o(t) {
        ...
        return (
          ...
          o.setAttribute(
            'class',
            e.linkClass + h + 'node-name--' + t.nodeName + h + e.extraLinkClasses,
          ),
          n.appendChild(o),
          n
        )
      ...
      function i() {
        ...
        ;('auto' === e.fixedSidebarOffset &&
          ...
          t > e.fixedSidebarOffset
            ...
            : (n.className = n.className.split(h + e.positionFixedClass).join('')))
      }
      function s(t) {
        ...
        if (m && null !== document.querySelector(e.tocSelector) && l.length > 0) {
          ...
          var a = document
            ...
            .querySelector(
              '.' + e.linkClass + '.node-name--' + o.nodeName + '[href="#' + o.id + '"]',
            )
  ...
  function (e, t) {
    e.exports = function (e) {
      ...
      function l(l, i) {
        for (
          var s = o(l), r = n(l), c = i, a = t(c), u = a ? a.headingLevel : 0, d = r - u;
          d > 0;
        )

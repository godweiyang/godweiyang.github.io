...
;(!(function () {
  ...
  ;((r.prototype = {
    ...
    (h.prototype = {
      ...
      mapData: function (t, e) {
        for (
          var r = -1, i = this.moduleCount - 1, n = 7, o = 0, a = this.moduleCount - 1;
          0 < a;
          a -= 2
        )
          for (6 == a && a--; ; ) {
  ...
  ;(((QRCode = function (t, e) {
    ...
    ;((this._oQRCode = new h(D(t, this._htOption.correctLevel), this._htOption.correctLevel)),
  ...
  (function (r, o, h) {
    ...
    ;((r.socialShare = function (t, e) {
      ;((t = 'string' == typeof t ? m(t) : t).length === h && (t = [t]),
        C(t, function (t) {
          t.initialized ||
            (function (t, e) {
              var r = (function () {
              ...
              ;((function (t, e) {
                ...
                (s = 'prepend' == a.mode),
                C(s ? n.reverse() : n, function (t) {
                  var n,
                    o,
                    e =
                      ((n = t),
                      (o = a).summary || (o.summary = o.description),
                      p[n].replace(/\{\{(\w)(\w*)\}\}/g, function (t, e, r) {
                        var i = n + e + r.toLowerCase()
                        return (
                          (r = (e + r).toLowerCase()),
                          encodeURIComponent((o[i] === h ? o[r] : o[i]) || '')
                        )
                      })),
                    r = a.initialized
                      ? w(i, 'icon-' + t)
                  ...
                  ;((r[0].href = e),
                    ...
                    a.initialized || (s ? i.insertBefore(r[0], i.firstChild) : i.appendChild(r[0])))
                }),
                (function (t, e) {

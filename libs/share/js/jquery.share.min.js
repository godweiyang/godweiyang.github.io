  ...
  function i(r, t, e, n, o, i, a, u) {
    ...
    p
      ? (function (r, t, e, n, o, i, a, u, f, c) {
        ...
        })(t, n, o, c, s, l, !m && !k, !m && !y, !A && !y, !A && !k)
      : (function (r, t, e, n, o, i, a, u, f, c) {
          ;(a &&
            (r.moveTo(t + i, e), r.lineTo(t, e), r.lineTo(t, e + i), r.arcTo(t, e, t + i, e, i)),
            u &&
              (r.moveTo(n - i, e), r.lineTo(n, e), r.lineTo(n, e + i), r.arcTo(n, e, n - i, e, i)),
            f &&
              (r.moveTo(n - i, o), r.lineTo(n, o), r.lineTo(n, o - i), r.arcTo(n, o, n - i, o, i)),
            c &&
              (r.moveTo(t + i, o), r.lineTo(t, o), r.lineTo(t, o - i), r.arcTo(t, o, t + i, o, i)))
    ...
    var r = (function () {
      ...
      var t = function (t, e) {
        var o = t,
          ...
          A = function (r, t) {
            for (
              var e = -1, n = l - 1, o = 7, a = 0, u = i.getMaskFunction(t), f = l - 1;
              f > 0;
              f -= 2
            )
              for (6 == f && (f -= 1); ; ) {
          ...
          k = function (r, t, e) {
            ...
            for (
              ;
              !(o.getLengthInBits() >= 8 * s) && (o.put(236, 8), !(o.getLengthInBits() >= 8 * s));
            )
              o.put(17, 8)
            return B(o, n)
          }
        return (
          (v.addData = function (r) {
            var t = c(r)
            ;(d.push(t), (g = null))
          }),
                  ...
                  for (var o = 0, i = r.isDark(n, s), a = -1; 1 >= a; a += 1)
                    if (!(0 > n + a || n + a >= t))
                      for (var u = -1; 1 >= u; u += 1)
                        0 > s + u ||
                          s + u >= t ||
                          ((0 != a || 0 != u) && i == r.isDark(n + a, s + u) && (o += 1))
                  o > 5 && (e += 3 + o - 5)
                }
              for (n = 0; t - 1 > n; n += 1)
                for (s = 0; t - 1 > s; s += 1) {
                ...
                ;((i.setPixel = function (r, t, n) {
                  ...
                  (i.write = function (r) {
                    ...
                    for (var o = 0; t.length - o > 255; )
                      (r.writeByte(255), r.writeBytes(t, o, 255), (o += 255))
                ...
                var a = function (r) {
                    ...
                    for (l += 1; l < o.length; ) {
                      ...
                      ;((l += 1),
                        i.contains(h + g)
                          ? (h += g)
                          : (c.write(i.indexOf(h), n),
                            i.size() < 4095 && (i.size() == 1 << n && (n += 1), i.add(h + g)),
                            (h = g)))
                    }
    ...
    ;((r.fn.share = function (t) {
      function e(t, e) {
        var n = (function (t) {
          ...
          var e = (r(window).width() <= 768 ? t.mobileSites : t.sites.length ? t.sites : []).slice(
              0,
            ),
            n = t.disabled
